...
const mongoURI = 'mongodb+srv://dev120:nildev%40223@cluster0.2bkkrhe.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'; // Assuming MongoDB is running on the specified IP and default port 27017
...
app.post('/signup', async (req, res) => {
  ...
  try {
    ...
    const collection = database.collection('signupdb');
...
app.get('/userlist', async (req, res) => {
  try {
    ...
    const collection = db.collection('signupdb');
